...
scoreboard objectives add Deathsworn_Toggle dummy
scoreboard objectives add Owner_UUID0 dummy
scoreboard objectives add Owner_UUID1 dummy
scoreboard objectives add Owner_UUID0_temp dummy
scoreboard objectives add Owner_UUID1_temp dummy
...
scoreboard objectives add Minions_Deployed dummy
